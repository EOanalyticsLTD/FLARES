...
from constants import DATA_DIR, DATA_DIR_CAMS_AN, DATA_DIR_ERA5, DATA_DIR_MERA, DATA_DIR_GFAS, DATA_DIR_LC, DATA_DIR_PLOTS, \
    DATA_DIR_DEM, S3_ENDPOINT, S3_ACCESS_KEY, S3_SECRET_KEY, S3_REGION_NAME, DATA_DIR_FIRES, DATA_DIR_CAMS_RE
...
def set_up_folder_structure():
    ...
    for dir_path in [DATA_DIR_CAMS_AN, DATA_DIR_CAMS_RE, DATA_DIR_ERA5, DATA_DIR_MERA, DATA_DIR_GFAS,
...
def download_data():
    ...
    # for each directory
    for dir_string in [DATA_DIR_CAMS_AN, DATA_DIR_CAMS_RE, DATA_DIR_MERA, DATA_DIR_ERA5,
                       DATA_DIR_GFAS, DATA_DIR_LC, DATA_DIR_DEM]:
...
def update_data():
    ...
    for dir_path in [DATA_DIR_CAMS_RE, DATA_DIR_CAMS_AN, DATA_DIR_ERA5, DATA_DIR_GFAS, DATA_DIR_MERA]:
        ...
        for file in s3_files:
            ...
            try:
                ...
                print(f'Could not find "{file}.zip", starting download from s3 bucket to {dir_path}')
                try:
                    s3_client.download_file(
                        s3_bucket,
                        f'{file}.zip',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Quick program to set up the data folder structure and download the data '
